...
import TimelineImg from "../assests/images/Factocad Journey.png"
...
const About = () => {
  return (
    ...
    <section className="py-20 my-10 bg-gray-200">
      ...
      {/* Factocad Journey Timeline Section - Darker Blue Background */}
      {/* <div className="bg-grey-500 py-16 mt-20">
        <div className="container mx-auto px-6 lg:px-20 text-center">
          <h2 className="text-3xl font-bold text-black mb-6">Our Journey</h2>
          <div className="flex justify-center">
            <img src={TimelineImg} alt="Factocad Journey" className="w-full max-w-4xl rounded-lg shadow-lg" />
          </div>
        </div>
      </div> */}
    </section>
